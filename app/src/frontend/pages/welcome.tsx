...
New datasets and features are added all the time. Any help you can give, colouring-in our building maps, and enriching and verifying our open datasets is very much appreciated. 
        ...
        <div className="image-row">
            <img src="images/logo-ccrp.jpg" alt="Colouring Adelaide collaborating organisations" />
            <img src="images/logo-turing.png" alt="Colouring Adelaide collaborating organisations" />
            <img src="images/logo-ucl.png" alt="Colouring Adelaide collaborating organisations" />
            <img src="images/logo-uq.png" alt="Colouring Adelaide collaborating organisations" />
            <img src="images/logo-curtin.jpg" alt="Colouring Adelaide collaborating organisations" />
            <img src="images/logo-swinburne.png" alt="Colouring Adelaide collaborating organisations" />
            <img src="images/logo-unisa.png" alt="Colouring Adelaide collaborating organisations" />
        </div>
    </div>
);
