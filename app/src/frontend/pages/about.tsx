...
const AboutPage = () => (
    <article>
        ...
        Colouring Adelaide is being designed to address these questions by crowdsourcing
        ...
        colouring Adelaide is being designed and built by the Centre for Advanced Spatial
        ...
        <section className="pale-green color-block">
            ...
            projects on the colouring Adelaide site.
