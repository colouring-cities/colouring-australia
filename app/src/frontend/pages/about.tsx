...
const AboutPage = () => (
    <article>
        ...
        Colouring Brisbane is being designed to address these questions by crowdsourcing
        ...
        colouring Brisbane is being designed and built by the Centre for Advanced Spatial
        ...
        <section className="pale-green color-block">
            ...
            projects on the colouring Brisbane site.
