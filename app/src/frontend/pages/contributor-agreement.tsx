...
const ContributorAgreementPage : React.SFC<any> = () => (
    <article>
        <section className='main-col'>
            ...
            <p>
                colouring Sydney emphasises local and community knowledge. Contributors use a variety of sources and local and expert knowledge of buildings to contribute data and verify that colouring Sydney is accurate and up to date.
            </p>
            <p>
                When you contribute to colouring Sydney, you make your contributions available as open data for anyone to copy, distribute, transmit and adapt in line with the licence.
            </p>
            <p>
            ...
            <p>
                When you make a contribution to colouring Sydney, you are creating a permanent, public record of all data added, removed, or changed by you.The database records the username and ID of the user making the edit, along with the time and date of the change.All of this information is also made publicly available through the website and through bulk downloads of the edit history.
            </p>
