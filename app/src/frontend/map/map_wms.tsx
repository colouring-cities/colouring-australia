...
class ColouringMap extends Component<ColouringMapProps, ColouringMapState> {
    ...
    render() {
        ...
        const attribution = 'Building attribute data is © Colouring Adelaide contributors. Maps contain OS data © Crown copyright: OS Maps baselayers and building outlines. <a href=/ordnance-survey-licence.html>OS licence</a>';
