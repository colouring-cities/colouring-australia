...
function getPasswordResetEmail(email: string, token: string, siteOrigin: string): nodemailer.SendMailOptions {
    ...
    Someone has requested a password reset for the Colouring Brisbane account associated with this email address.
    ...
    return {
        text: messageBody,
        subject: 'Reset your Colouring Brisbane password',
        to: email,
