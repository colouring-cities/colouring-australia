...
function renderHTML(context, data, req, res) {
    ...
    <head>
        ...
        <meta property="og:title"              content="colouring Sydney" />
        <meta property="og:description"        content="colouring Sydney is a knowledge exchange platform collecting information on every building in London, to help make the city more sustainable. We’re building it at The Bartlett Centre for Advanced Spatial Analysis, University College London." />
        ...
        <meta name="apple-mobile-web-app-title" content="colouring Sydney">
        <link rel="apple-touch-icon" href="icon-192x192.png">

        <meta name="mobile-web-app-capable" content="yes">
        <link rel="icon" sizes="192x192" href="icon-192x192.png">

        <title>Colouring Sydney</title>
